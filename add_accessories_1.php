...
<head>
    ...
    <title>Adding a new Accessory</title>
            ...
            <div class="col-lg-8 mt-3">
                ...
                <form action="add_product_2.php" method="post" class="form my-5 col-lg-8 col-md-8">
                    <div class="form-group">
                        <label class="form-label mt-4" for="inputValid">Accessory Type</label>
                        <input type="text"
                        value="" name="title"
                        class="form-control" id="inputValid">
                        <div class="valid-feedback">Accessory Type is ok</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="valid-feedback">Name is ok</div>
                    </div><!--end of form group -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="valid-feedback">Quantity is ok</div>
                    </div><!--end of form group -->
                    ...
                    <div class="form-group" style="margin-bottom:20px;">
                        ...
                        <div class="valid-feedback">Picture updated</div>
                    </div><!--end of form group -->
