...
<head>
    ...
    <title>Add new services step 3/3</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mt-3">
                ...
                <div class="alert alert-dismissible alert-success">
                    ...
                    <strong>Record</strong> Successfully added to the table.
                    <br>
                    <a href="services.php" class="btn btn-success mt-5">Add Another Record</a>
                </div>
                ...
                <div class="alert alert-dismissible alert-danger">
                    <h3>Failed</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    <strong>Sorry</strong> Saving new record failed.!
                    <br>
                    <a href="services.php" class="btn btn-danger mt-5">Try Again</a>
                </div>
                <?php
